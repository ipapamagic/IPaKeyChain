...
open class IPaKeyChain :Sequence{
    ...
    open func secItemUpdate(_ attributesToUpdate:IPaKeyChain) -> OSStatus {
...
open class IPaKeyChainPassword:IPaKeyChain {
...
open class IPaKeyChainKeyIdentity:IPaKeyChain {
